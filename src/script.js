...
const tick = () =>
{
    setupKeyControls();
     ...
     //rocket.mesh.position.add(rocket.thrust().clone().multiplyScalar(delteTime));
      ...
      console.log(rocket)
      document.getElementById('rocket-total-mass').innerText = rocket.total_mass.toFixed(3) + ' kg';
      document.getElementById('rocket-force_angle').innerText = rocket.force_angle.toFixed(3) + ' kk ';
